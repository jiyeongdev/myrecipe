...
//             // Google 사용자 정보 요청
//             Map<String, Object> userInfoMap = googleAuthService.getGoogleUserInfo(googleAccessToken);
//             log.info("Google 사용자 정보: {}", userInfoMap);

//             // Map을 GoogleUserInfo 객체로 변환
//             GoogleUserInfo userInfo = new GoogleUserInfo(
//                 (String) userInfoMap.get("email"),
//                 (String) userInfoMap.get("name"),
//                 (String) userInfoMap.get("picture"),
//                 (String) userInfoMap.get("sub")
//             );

//             // 사용자 정보 저장/업데이트
//             GoogleAuthService.GoogleLoginResponse response = googleAuthService.saveOrUpdateGoogleUser(userInfo);

//             Map<String, Object> responseMap = new HashMap<>();
//             responseMap.put("isNewUser", response.isNewUser());
//             responseMap.put("accessToken", response.token());

//             // Refresh Token을 HTTP-Only 쿠키로 설정
//             ResponseCookie refreshTokenCookie = ResponseCookie.from(refreshTokenCookieName, response.token())
...
//                     .body(new ApiResponse<>("Google 로그인 성공", responseMap, HttpStatus.OK));
//         } catch (Exception e) {
